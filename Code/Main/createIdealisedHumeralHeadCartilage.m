...
% 
% This code works in the same way as the createHumeralHead cartilage
% function, but just with the idealise smooth humeral head sphere as the
% input STL and output cartilage mesh. The original humeral head file is
% still used to identify cartilage thickness though.
%
...
headSTL = import_STL('IdealisedHumeralHeadSurface_GlenoidCoordinateSystemAligned.stl');
...
%Export STL file
export_STL_txt('IdealisedHumeralHeadCartilage_GlenoidCoordinateSystem.stl',stlStruct);
